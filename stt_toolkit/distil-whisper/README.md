...
The main difference is that vLLM backedn was used for pseudo-labelling instead of transofrmers.

If you are interested in comparing the original Distil-Whisper code, I refer you to the original sub-folder [training](https://github.com/huggingface/distil-whisper/tree/main/training).
